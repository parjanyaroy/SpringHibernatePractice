...
public class AutoWiredEmployeeAddress {
	...
	public AutoWiredEmployeeAddress(int id, String city, String state,List<Integer> locationCodes) {
		super();
		this.id = id;
		this.city = city;
		this.state = state;
	...
	public AutoWiredEmployeeAddress() {
		super();
	}
